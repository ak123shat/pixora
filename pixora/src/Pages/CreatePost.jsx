...
const CreatePost = () => {
  ...
  return (
    <div min-h-screen bg-gradient-to-b from-slate-50 to-white>
      <div className='max-w-6xl mx-auto p-6'>
        {/* Title */}
        <div className='mb-8'>
          <h1 className='text-3xl font-bold text-slate-900 mb-2'>Create a New Post</h1>
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
            ...
            })} className='text-sm bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white font-medium py-2 px-8 rounded-md cursor-pointer'>Publish Post</button>
          </div>
        </div>
      </div>
    </div>
