...
const ProfileModal = ({setShowEdit}) => {
  ...
  const handleSaveProfile = async (e) => {
    e.preventDefault();
    // Implement the save profile logic here
  };
              ...
              <div className='flex flex-col items-start gap-4'>
                <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                  ...
                  <div className='group/profile relative'>
                    <img
                      src={editForm.profile_picture ? URL.createObjectURL(editForm.profile_picture) : 'user-placeholder.png'}
                      alt="Profile Preview"
              ...
              <div className='flex flex-col items-start gap-3'>
                <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                  ...
                  <div className='group/cover relative'>
                    <img
                      src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : 'cover-placeholder.png'}
                      alt="Cover Preview"
